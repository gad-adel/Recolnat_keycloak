...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="${resourceUrl}/assets/index-sihFV1NS.js"></script>
    <link rel="stylesheet" crossorigin href="${resourceUrl}/assets/index-fWBYmwO3.css">
